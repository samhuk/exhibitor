...
export const PLAYWRIGHT_REPORT_FILE_REL = `${PLAYWRIGHT_REPORTS_DIR}/${PLAYWRIGHT_REPORT_OUTFILENAME}` as const
export const PLAYWRIGHT_REPORT_FILE = `${BUILD_OUTPUT_ROOT_DIR}/${PLAYWRIGHT_REPORT_FILE_REL}` as const
...
export const PLAYWRIGHT_HTML_REPORT_DATA_START_TOKEN = 'window.playwrightReportBase64 ='
